CHAIRS = {
    "data_driven_analysis_design_materials": {
        "name": "Data-Driven Analysis and Design of Materials",
        "group": "A - Me",
        "modules": [
    ...
    "getriebe_antriebstechnik": {
        "name": "Getriebe- und Antriebstechnik",
        "group": "A - Me",
        "modules": [
            "antriebstechnik",
            "fahrzeugantriebe",
    ...
    "kolbenmaschinen_verbrennungsmotoren": {
        "name": "Kolbenmaschinen / Verbrennungsmotoren",
        "group": "A - Me",
        "modules": [
    ...
    "produktionsorganisation_logistik": {
        "name": "Produktionsorganisation und Logistik",
        "group": "Mi - Sc",
        "modules": [
            "fabrikplanung",
    ...
    "schiffstechnische_konstruktionen": {
        "name": "Schiffstechnische Konstruktionen",
        "group": "Mi - Sc",
        "modules": [
            "schiffs_offshorekonstruktionen",
            "labor_schiffs_und_meerestechnik",
    ...
    "technische_mechanik_dynamik": {
        "name": "Technische Mechanik / Dynamik",
        "group": "St - W",
        "modules": [
            "technische_mechanik_1",
            "technische_mechanik_2",
