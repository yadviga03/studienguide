...
TRANSLATIONS = {
    "de": {
        ...
        "home_intro": "Wir als MaFIa – MaschinenbauFachschaftsInitiative wollten euch eine übersichtliche Orientierung für das Studium zusammenstellen. Gerade am Anfang verliert man bei den vielen Modulen, Vertiefungen und Lehrstühlen schnell den Überblick. Wir hoffen, dass euch die Seite bei der Orientierung hilft und die Modulenwahl ein bisschen einfacher macht. Falls euch Inhalte fehlen oder ihr eigene Erfahrungen teilen möchtet, schreibt uns gerne auf <a href='https://www.instagram.com/mafia_uni_rostock/' target='_blank'>Instagram (@mafia_uni_rostock)</a> oder per Mail an <a href='mailto:fachschaft.mbst@uni-rostock.de'>fachschaft.mbst@uni-rostock.de</a>.",
        "home_disclaimer": "Diese Website ist keine offizielle Seite der Universität oder Fakultät. Alle Inhalte dienen nur zur Orientierung und können unvollständig oder veraltet sein, informiert euch deshalb zusätzlich immer selbst.",
        ...
        "non_technical_area": "Nichttechnischer Wahlpflichtbereich",
        ...
        "footer": "Studienguide der Fachschaft – keine offizielle Website, sondern eine Orientierungshilfe und erste Übersicht fürs Studium.",
    ...
    "en": {
        ...
        "home_intro": "We as MaFIa (MaschinenbauFachschaftsInitiative) wanted to create a clear orientation guide for your studies. Especially at the beginning, it is easy to lose track of all the modules, specializations and chairs. We hope this website helps you with orientation and makes choosing modules a little easier. If information is missing or you would like to share your own experiences, feel free to contact us on <a href='https://www.instagram.com/mafia_uni_rostock/' target='_blank'>Instagram (@mafia_uni_rostock)</a> or via email at <a href='mailto:fachschaft.mbst@uni-rostock.de'>fachschaft.mbst@uni-rostock.de</a>.",
        "home_disclaimer": "This website is not an official website of the university or faculty. All content is provided for orientation purposes only and may be incomplete or outdated. Please make sure to additionally verify information yourself.",        "study_programs": "Study programs",
        "chairs": "Chairs",
        "chairs_desc": "If you would like to see which chairs exist at our faculty and which modules they offer, you can find an overview here.",
        "study_programs_desc": "Here you can find an overview by degree program. Select your degree program and discover all modules that, according to our current information, you can choose from.",        "chairs_desc": "Overview of chairs and associated subject areas.",
        ...
        "footer": "Study guide from the student council – not an official website, but an orientation guide and first overview for your studies.",
