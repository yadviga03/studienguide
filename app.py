...
TRANSLATIONS = {
    "de": {
        ...
        "home_intro": "Wir als MaFIa – MaschinenbauFachschaftsInitiative wollten euch eine übersichtliche Orientierung für das Studium zusammenstellen. Gerade am Anfang verliert man bei den vielen Modulen, Vertiefungen und Lehrstühlen schnell den Überblick. Wir hoffen, dass euch die Seite ein bisschen bei der Orientierung hilft und die Studienwahl einfacher macht. Falls euch Inhalte fehlen oder ihr eigene Erfahrungen teilen möchtet, schreibt uns gerne auf Instagram oder per Mail.",
