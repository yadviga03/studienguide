...
TRANSLATIONS = {
    ...
    "en": {
        ...
        "home_intro": "We as MaFIa (MaschinenbauFachschaftsInitiative) wanted to create a clear orientation guide for your studies. Especially at the beginning, it is easy to lose track of all the modules, specializations and chairs. We hope this website helps you with orientation and makes choosing modules a little easier.<br><br>If information is missing or you would like to share your own experiences, feel free to contact us on <a href='https://www.instagram.com/mafia_uni_rostock/' target='_blank'> 🔗Instagram</a> or via email at <a href='mailto:fachschaft.mbst@uni-rostock.de'> 🔗fachschaft.mbst@uni-rostock.de</a>.",
